...
#'
#' Simple feature collection of NYC Census Blocks from 2010.
#' EPSG:2263, NAD83 / New York Long Island (ftUS).
#'
#' @format ## `nyc_census_blocks_2010_sf`
#' A simple feature collection with 38797 rows and 8 columns:
#' \describe{
#'   \item{cb2010}{2010 census block number (4-digit)}
#'   \item{boro_code}{Borough code as character (1=Manhattan, 2=Bronx, 3=Brooklyn, 4=Queens, 5=Staten Island)}
#'   \item{boro_name}{Borough name}
#'   \item{ct2010}{2010 census tract number (6-digit)}
#'   \item{bctcb2010}{Unique identifier for 2010 census blocks (BoroCode + CT2010 + CB2010)}
#'   \item{shape_leng}{Shape length}
#'   \item{shape_area}{Shape area}
#'   \item{geometry}{Multipolygon}
#' }
...
#' island of Manhattan: the Marble Hill neighborhood, which sits just across
#' the Broadway Lift Bridge in the Bronx.
#'
#' @author Kieran Healy
#' @source <https://www.nyc.gov/content/planning/pages/resources#datasets>
